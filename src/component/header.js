export function Header() {
    ...
    controlsBar.style.padding = '10px 20px'; // 内边距
    controlsBar.style.boxSizing = 'border-box'; // 保持一致
    ...
    showOptionsButton.addEventListener('click', () => {
        ...
        defaultFile.textContent = 'http://localhost/drc/pointcloud.mpd';
        defaultFile.style.marginBottom = '20px';
        ...
        defaultFile.addEventListener('click', () => {
            document.getElementById('mpd-input').value = document.getElementById('default-file').textContent;
        });

        confirmButton.addEventListener('click', () => {
            document.getElementById('mpd-input').value = document.getElementById('default-file').textContent; // 默认选中
